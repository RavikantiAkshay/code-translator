        ...
        return (
            <div className="output-cards">
                <div className = "output-cards-row">
                    <InfoCard label = "Time Complexity" value = {result.analysis.time || "N/A"} />
                    <InfoCard label = "Space Complexity" value = {result.analysis.space || "N/A"} />                   
                </div>    
                {result.explanation && <p className = "output-explanation">{result.explanation}</p>}
            </div>
        );
    }
        ...
        return (
            <div className="output-flex-col">
                <div className = "output-editor-area">
                    <CodeEditor code={result.optimizedCode || " "} onChange = {() => {}} language={result.language} readOnly/>
                </div>
                {result.suggestions && (
