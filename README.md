...
An elite, full-stack MERN utility designed for developers. It leverages the high-performance **Groq qwen/qwen3.6-27b** engine (`groq-sdk`) to translate, optimize, analyze, and explain code within a premium, high-performance monochrome workspace.
...
- **GenAI Client:** Official Groq SDK (`groq-sdk` model `qwen/qwen3.6-27b`)
